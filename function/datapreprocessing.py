...
from transformers import RobertaForSequenceClassification, RobertaConfig, PhobertTokenizer
...
class DataPreprocessing:
    def __init__(self, path):
        ...
        self.rdrsegmenter = VnCoreNLP("H:\\VietNamese-Sentiment-Analyst\\PhoBert\\vncorenlp\\VnCoreNLP-1.1.1.jar", annotators="wseg", max_heap_size='-Xmx500m')
    ...
    def fit_transform(self, comment):
        ...
        # Mã hóa văn bản
        inputs = self.tokenizer(segmented_text, return_tensors="pt", padding=True, truncation=True, max_length=131)
    ...
    def WordSeparation(self, comments):
        return [review.split() for review in comments]
